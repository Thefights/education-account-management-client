    ...
    <Card>
      <Flex vertical gap={16}>
        <Flex justify="space-between" align="center">
          <Typography.Title level={4}>{t('topup.history_title')}</Typography.Title>
          <Button
            onClick={() =>
            ...
            <Col xs={24} md={5}>
              <Form.Item label={t('topup.search_execution')} style={{ marginBottom: 0 }}>
                <Input
                  ...
                  placeholder={t('topup.search_execution')}
                />
              </Form.Item>
            </Col>
            <Col xs={24} md={4}>
              <Form.Item label={t('topup.source')} style={{ marginBottom: 0 }}>
                <Select
                  ...
                  onChange={(v) => setFilter('sourceTypes', v)}
                  options={options(EnumConfig.TopupExecutionSourceTypeId)}
            ...
            <Col xs={24} md={4}>
              <Form.Item label={t('topup.status')} style={{ marginBottom: 0 }}>
                <Select
                  ...
                  options={options(EnumConfig.TopupExecutionStatusId)}
                  placeholder={t('text.all')}
                  style={{ width: '100%' }}
                />
              </Form.Item>
